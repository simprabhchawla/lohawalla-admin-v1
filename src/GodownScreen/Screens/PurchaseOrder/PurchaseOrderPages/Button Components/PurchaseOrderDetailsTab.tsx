...
export const PurchaseOrderDetailsTab = ({ disabled }: any) => {
              ...
              <tr className='border'>
                ...
                <td className='flex p-[12px]  flex-col border rounded-xl'>
                  ...
                  <div className="container flex justify-between mx-auto mt-10">
                    <span className='font-bold text-[18px] text-black px-[13px]'>Godown</span>
                    <span className='font-bold text-[18px] text-black px-[13px]'>Quantity</span>
                  </div>
                </td>

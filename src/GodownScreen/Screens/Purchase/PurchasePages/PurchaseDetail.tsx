...
import { PurchaseTab } from './Button Components/PurchaseTab';
import { PartyDetailsTab } from './Button Components/PartyDetailsTab';
import { PurchaseDetailsTab } from './Button Components/PurchaseDetailsTab';
                ...
                <div className="">
                    {activeTab === 'Purchase Order' && (
                        <div className={`p-[16px] ${PurchaseOrderDisabled ? 'disabled' : ''}`}>
                            <PurchaseTab disabled={PurchaseOrderDisabled} />
                        </div>
                    )}
                    ...
                    {activeTab === 'Purchase Order Details Page' && (
                        <div className={`p-[16px] ${PurchaseOrderDetailsDisabled ? 'disabled' : ''}`}>
                            <PurchaseDetailsTab disabled={PurchaseOrderDetailsDisabled} />
                        </div>
                    )}
                </div>
            </div>

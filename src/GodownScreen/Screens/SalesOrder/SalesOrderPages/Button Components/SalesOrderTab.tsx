import { updateSingleSalesOrderAsync } from "@src/Redux/Slice/GodownManager/SalesOrder/SalesOrderSlice";
import icon from "../../../../../assets_/Godown Ions images//app-window.svg"
import { useEffect, useState } from "react";
import { useForm } from "react-hook-form";
import { useDispatch } from "react-redux";

export const SalesOrderTab = ({ disabled, Salesdata, id }: any) => {
  console.log(id)
  ...
  const onSubmit = () => {
    ...
    dispatch(updateSingleSalesOrderAsync(salesOrder))
  };
    ...
    <div className="p-[40px] gap-[40px] flex flex-col border-2 rounded-xl">
      <form onSubmit={handleSubmit(onSubmit)} >
        ...
        <div className="flex justify-between pb-5 items-center gap-[21px]">
          <div className="flex text-[#005D7F] w-[190px] text-[24px] font-medium">
            Sales Order
          </div>

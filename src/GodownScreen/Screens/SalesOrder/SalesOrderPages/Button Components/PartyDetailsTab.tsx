...
export const PartyDetailsTab = ({ disabled, Salesdata }: any) => {
  console.log("hihihih", Salesdata)
      ...
      <div className="flex  gap-[20px] w-[100%]">
        <div className="border-2 w-full rounded-xl p-[20px] gap-[20px] flex flex-col">
          ...
          <div className="w-full flex justify-between gap-[50px]">
            <div className="flex w-[50%] gap-[20px] flex-col">
              <div className="flex gap-[10px] flex-col">
                ...
                <input
                  type="text"
                  value={Salesdata?.customer?.customerCode}
              ...
              <div className="flex gap-[10px] flex-col">
                ...
                <input
                  type="text"
                  value={Salesdata?.customer?.customerName}
                  className="outline-none border rounded-lg p-[10px]"
                  disabled
                />
              </div>
            ...
            <div className="flex w-[50%] gap-[20px] flex-col">
              <div className="flex gap-[10px] flex-col">
                ...
                <input
                  type="text"
                  value={Salesdata?.customer?.gstNumber}
                  className="outline-none border rounded-lg p-[10px]"
                  disabled
                />
              </div>
              <div className="flex gap-[10px] flex-col">
                ...
                <input
                  type="text"
                  value={Salesdata?.customer?.panCode}
                  className="outline-none border rounded-lg p-[10px]"
                  disabled
                />
              </div>
          ...
          <div className="flex gap-[10px] flex-col">
            <span>Address</span>
            <textarea
              value={`${Salesdata?.customer?.address1} ${Salesdata?.customer?.address2} ${Salesdata?.customer?.city}`}

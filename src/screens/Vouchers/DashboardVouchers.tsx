...
export const DashboardVouchers = () => {
  ...
  const vouchersData = useSelector(
    (state: any) => state.voucher?.data?.vouchers
  );
          ...
          <div className="flex flex-col h-[80vh] overflow-auto">
            <div className="flex justify-between">
              ...
              <div className="pt-[32px]">
                <button
                  onClick={openPopup}
                  className="flex px-[20px] text-white py-[10px] justify-center items-center rounded-[8px] border bg-[#005D7F]"
                >
                  <img src={add} alt="" />
                  Create Vouchers
                </button>
            ...
            <div>
              {activeTab === "Voucher" && (
                <div className="p-[16px]">
                  <VoucherEntry vouchersData={vouchersData} />
                </div>
              )}
            </div>

...
export default function CurrentEmployeeTable(props: Props) {
  ...
  const getTotal = async () => {
    const { data } = await axios.get(
      `${basePath}admin/pages/employeeListing/getVerifiedEmployee`,
                ...
                (
                  ...
                  return (
                    <tr key={i}>
                      ...
                      <td className="px-6 py-3  font-normal">
                        <div className="flex gap-2 ">
                          <p className="text-sm text-slate-800">
                            {dataPermissions ? "True" : "False"}
                          </p>
                          <img
                            src={edit}
                            alt=""
                            onClick={() => openPopupPermission(id)}
                            className="w-[16px] cursor-pointer h-[16px]"
                          />
                        </div>
                      </td>
                      ...
                      <td
                        onClick={() => openChangePopup(id)}
                        className="px-6 flex cursor-pointer gap-[5px] py-3 font-normal"
                      >
                        <p className="text-sm text-[#B72626]">Change</p>
                        <img src={change} alt="" />
                      </td>
            ...
            <div className="bg-[#fff] px-[32px] py-[25px] w-[563px] h-[457px] rounded-[40px] shadow-lg flex flex-col">
              ...
              <div className="flex flex-col gap-[48px]">
                <div className="flex flex-col justify-center items-center gap-[6px]">
                  ...
                  <h1 className="text-[40px] text-[#5C5C77] font-[700]">
                    Change Role
                  </h1>
                </div>
                ...
                <div className="flex flex-col gap-[56px]">
                  <div className="flex flex-col gap-[10px]">
                    ...
                    <select
                      className="border border-[#9797AA] rounded-[8px]"
                      value={role}
                  ...
                  <button
                    ...
                    className="bg-[#5C5C77] py-[16px] text-white rounded-[10px] text-[16px] font-bold"
                  >
                    Save
                  </button>
                </div>
            ...
            <div className="bg-[#fff] px-[32px] py-[25px] w-[563px] h-[565px] rounded-[40px] shadow-lg flex flex-col">
              <div className="flex px-[56px] py-[53px] flex-col gap-[48px]">
                ...
                <div className="flex flex-col gap-[56px]">
                  ...
                  <div className="flex flex-col gap-[10px]">
                    ...
                    <input
                      ...
                      className="border border-[#9797AA] rounded-[8px]"
                    />
                    {tpassword.length > 0 && password !== tpassword && (
                      <p className=" top-6 text-sm text-[#B72626]">
                ...
                <div className="flex justify-center items-center gap-[25px]">
                  <button
                    onClick={closeChangePopup}
                    className="flex w-[213px] bg-[#ebecee] text-center justify-center font-bold  rounded-[10px] py-[16px]"
                  >
                    Cancel
                  </button>
                  {tpassword === password && tpassword.length > 0 && (
                    <button
                      ...
                      className="bg-[#5C5C77] w-[213px] text-center justify-center flex py-[16px] text-white rounded-[10px] text-[16px] font-bold"
                    >
                      Save
                    </button>
                  )}
        ...
        <div className="flex bg-white border-t-2 border-gray-100 py-6 text-sm">
          <div className="px-3">
            ...
            <label className="text-zinc-700 pl-4">
              {page > 1 ? (page - 1) * limit : 1}-{page * limit} of {total}{" "}
              items
            </label>
          </div>
          <div className="ml-auto px-6 flex items-center">
            <div className="bg-theme-btn-gray px-2 py-0.5 border-2 text-zinc-500 border-gray-50 rounded-lg">
              <p>{page}</p>
            </div>
                ...
                <button
                  onClick={() =>
                    page < pageCount || pageCount == 0
                      ? setPage(page + 1)
                      : alert("You reached on maximum limit")
                  }
                >
                  <Icon
                    className="inline-block"

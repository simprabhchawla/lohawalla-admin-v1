...
import { AllVouchersDataApi, addVouchersAPI, deleteCustomerApi, editCustomerAPI } from '../../Api/Admin/customerApi';
...
export const getVouchersAsync: any = createAsyncThunk('getVouchersAsync', async () => {
  try {
    const data = await AllVouchersDataApi();
    return data;
  } catch (error) {
    throw error;
  }
